    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!(mailGot.equals("") || pwdGot.equals(""))) {
                    mAuth.signInWithEmailAndPassword(mailGot, pwdGot).addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(getActivity(), "Credenziali errate. Ti preghiamo di inserire quelle corrette",
                    ...
                    Log.w(TAG, "createUserWithEmail:nulloneorboth");
                    Toast.makeText(getActivity(), "Uno o due campi richiesti sono vuoti! Inseriscili correttamente",
                            Toast.LENGTH_SHORT).show();
